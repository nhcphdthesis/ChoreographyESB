...
public class SendToMuleB implements JavaDelegate {
	
	@Override
	public void execute(DelegateExecution execution) throws Exception {
		// TODO Auto-generated method stub
		String id = execution.getId();
		String Aid = (String) execution.getVariable("idA");
		System.out.println("retrieved A id: "+Aid);
...
//			client.send("http://localhost:8081/activiti/"+id, "/activiti/"+id, null);
			client.dispatch("vm://receiveB", id+"/"+Aid, null);
